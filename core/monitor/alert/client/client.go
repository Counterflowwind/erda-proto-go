...
func (s *alertDetailServiceWrapper) QueryDashboardAlertMetrics(ctx context.Context, req *pb.QueryDashboardAlertMetricsRequest) (*pb.QueryDashboardAlertMetricsResponse, error) {
	return s.client.QueryDashboardAlertMetrics(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}

func (s *alertDetailServiceWrapper) QueryDashboardMetrics(ctx context.Context, req *pb.QueryDashboardMetricsRequest) (*pb.QueryDashboardMetricsResponse, error) {
	return s.client.QueryDashboardMetrics(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
...
func (s *alertDetailServiceWrapper) QuerySystemAddonMetrics(ctx context.Context, req *pb.QuerySystemAddonMetricsRequest) (*pb.QuerySystemAddonMetricsResponse, error) {
	return s.client.QuerySystemAddonMetrics(ctx, req, append(grpc.CallOptionFromContext(ctx), s.opts...)...)
}
